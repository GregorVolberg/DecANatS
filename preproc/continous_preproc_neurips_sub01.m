...
%door_artifact_def       = arfct.artfctdef.door.artifact;
%newsegment_artifact_def = arfct.artfctdef.newsegment.artifact;
save(strcat(derivates_prefix, 'artifact_def.mat'), "arfct");
% arfct = importdata(strcat(derivates_prefix, 'artifact_def.mat'));
