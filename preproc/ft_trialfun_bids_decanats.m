...
target_corners    = unique(events.label_abs_pos(startsWith(events.label_abs_pos, 'corner_')));
on_off_corners    = cellfun(@(x) (find(diff(ismember(events.label_abs_pos, x))) + 1), target_corners, ...
                    'UniformOutput', false);
